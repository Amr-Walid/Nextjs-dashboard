...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        /* ─── Burgundy/Crimson Dark Surfaces ─── */
        surface: {
        ...
        /* ─── Legacy Compat (keeping minimal to not break undefined) ─── */
        primary: { DEFAULT: "#00f2fe" },
        dark: {
          DEFAULT: "#111827",
          2: "#1F2A37",
          3: "#374151",
